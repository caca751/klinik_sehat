...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 21, 2026 at 06:23 AM
...
(12, 'BKG-20260721-0001', 13, 8, 1, NULL, '2026-07-21', 'gigi saya sakit', 'Menunggu', '2026-07-21 10:55:30'),
(13, 'BKG-20260721-0002', 13, 3, 1, 25, '2026-07-23', 'kelamin saya sakit 🤮', 'Menunggu', '2026-07-21 10:56:06');
...
(1, 1, 'dr. Andi Wijaya, Sp.PD', 'Laki-laki', '0812-1001', 'andi.wijaya@kliniksehat.id', 'STR-001', 150000.00, 'dr_Andi.png'),
(2, 2, 'dr. Siti Nurhaliza, Sp.A', 'Perempuan', '0813-2002', 'siti.nurhaliza@klinik.id', 'STR-002', 120000.00, 'dr_Siti.png'),
(3, 3, 'dr. Budi Santoso, Sp.KK', 'Laki-laki', '0814-3003', 'budi.santoso@klinik.id', 'STR-003', 130000.00, 'dr_Budi.png'),
(4, 4, 'dr. Rina Sari, Sp.JP', 'Perempuan', '0815-4004', 'rina.sari@klinik.id', 'STR-004', 200000.00, 'dr_Rina.png'),
(5, 5, 'dr. Ahmad Fauzi, Sp.S', 'Laki-laki', '0816-5005', 'ahmad.fauzi@klinik.id', 'STR-005', 180000.00, 'dr_Ahmad.png'),
(6, 6, 'dr. Dewi Lestari, Sp.THT', 'Perempuan', '0817-6006', 'dewi.lestari@klinik.id', 'STR-006', 140000.00, 'dr_Dewi.png'),
(7, 7, 'dr. Eko Prasetyo, Sp.M', 'Laki-laki', '0818-7007', 'eko.prasetyo@klinik.id', 'STR-007', 160000.00, 'dr_Eko.png'),
(8, 8, 'dr. Maya Putri, Sp.G', 'Perempuan', '0819-8008', 'maya.putri@klinik.id', 'STR-008', 135000.00, 'dr_Maya Putri.png'),
(9, 9, 'dr. Fajar Nugroho, Sp.OT', 'Laki-laki', '0820-9009', 'fajar.nugroho@klinik.id', 'STR-009', 170000.00, 'dr_Fajar.png'),
...
--
-- Table structure for table `harga_stok_apotek`
--
...
--
-- Dumping data for table `harga_stok_apotek`
--
...
(28, 13, 'Booking Diterima', 'Booking BKG-20260721-0001 berhasil dibuat.', 'belum dibaca', '2026-07-21 10:55:30'),
(29, 13, 'Booking Diterima', 'Booking BKG-20260721-0002 berhasil dibuat.', 'belum dibaca', '2026-07-21 10:56:06');
...
(1, 'Administrator', 'admin@apotek.com', '$2y$10$3Buaz.yIWtX4xAdA0o6AJOpSJxotottesd34OfWz4kAsWBrk.hOIu', 2147483647, 'Jl. Clinic Sehat No. 1, Jakarta', NULL, 'admin', '2025-01-01 08:00:00'),
(2, 'Budi Santoso', 'budi@gmail.com', '$2y$10$l/u7HNgOAOyMRD7DRjMHieQVm.kq0WeGcPtfeOPuJNvQ75PlmYl2a', 2147483647, 'jnjbb', NULL, 'customer', '2025-02-03 09:15:00'),
(3, 'Siti Rahayu', 'siti@gmail.com', '$2y$10$l/u7HNgOAOyMRD7DRjMHieQVm.kq0WeGcPtfeOPuJNvQ75PlmYl2a', 2147483647, 'Jl. Mawar No. 8, Surabaya', NULL, 'customer', '2025-02-10 10:00:00'),
(4, 'Ahmad Fauzi', 'ahmad@gmail.com', '$2y$10$l/u7HNgOAOyMRD7DRjMHieQVm.kq0WeGcPtfeOPuJNvQ75PlmYl2a', 2147483647, 'Jl. Pahlawan No. 45, Yogyakarta', NULL, 'customer', '2025-03-01 11:30:00'),
(5, 'Dewi Lestari', 'dewi@gmail.com', '$2y$10$l/u7HNgOAOyMRD7DRjMHieQVm.kq0WeGcPtfeOPuJNvQ75PlmYl2a', 2147483647, 'Jl. Kenanga No. 3, Semarang', NULL, 'customer', '2025-03-12 13:45:00'),
(6, 'Rina Anggraini', 'rina@gmail.com', '$2y$10$l/u7HNgOAOyMRD7DRjMHieQVm.kq0WeGcPtfeOPuJNvQ75PlmYl2a', 2147483647, 'Jl. Anggrek No. 21, Medan', NULL, 'customer', '2025-03-20 08:20:00'),
(7, 'Joko Widodo', 'joko@gmail.com', '$2y$10$l/u7HNgOAOyMRD7DRjMHieQVm.kq0WeGcPtfeOPuJNvQ75PlmYl2a', 2147483647, 'Jl. Melati No. 7, Makassar', NULL, 'customer', '2025-04-02 14:10:00'),
(8, 'Sri Wahyuni', 'sri@gmail.com', '$2y$10$l/u7HNgOAOyMRD7DRjMHieQVm.kq0WeGcPtfeOPuJNvQ75PlmYl2a', 2147483647, 'Jl. Flamboyan No. 9, Denpasar', NULL, 'customer', '2025-04-15 09:50:00'),
(9, 'Eko Prasetyo', 'eko@gmail.com', '$2y$10$l/u7HNgOAOyMRD7DRjMHieQVm.kq0WeGcPtfeOPuJNvQ75PlmYl2a', 2147483647, 'Jl. Cendana No. 14, Palembang', NULL, 'customer', '2025-05-01 16:00:00'),
(10, 'Maya Sari', 'maya@gmail.com', '$2y$10$l/u7HNgOAOyMRD7DRjMHieQVm.kq0WeGcPtfeOPuJNvQ75PlmYl2a', 2147483647, 'Jl. Dahlia No. 33, Bekasi', NULL, 'customer', '2025-05-18 10:30:00'),
(11, 'Bayu Firmansyah', 'bayu@gmail.com', '$2y$10$l/u7HNgOAOyMRD7DRjMHieQVm.kq0WeGcPtfeOPuJNvQ75PlmYl2a', 2147483647, 'Jl. Teratai No. 5, Depok', NULL, 'customer', '2025-06-01 12:00:00'),
(12, 'salsa rommero', 'salsarommero@gmail.com', '$2y$10$nQEoEdy4Fk3TJfKwmMAYhOxvpBDRUZu7JhYT0ssVJugmNF/i7FPQu', 215484, 'blok m', NULL, 'customer', '2026-07-17 11:58:07'),
(13, 'caca', 'caca@gmail.com', '$2y$10$oa53QuwwA54wisyZK2CmiewDDu7PTiMUkp97Ve7cclV4V9wwLQ2b6', 21584, 'blok m', '2005-07-11', 'customer', '2026-07-17 12:51:22'),
(14, 'rara', 'raragemas@gmail.com', '$2y$10$dGezTXDdwYc8tdZQAavl0.xyhiEjjWX7LIK6plmLzOXlaqBg2dh6i', 812345678, 'Jl. Borobudur No.56', '2005-08-10', 'customer', '2026-07-17 21:15:54');
...
ALTER TABLE `apotek`
  ...
  ADD KEY `fk_apotek_kota` (`id_kota`);
...
ALTER TABLE `detail_pesanan`
  ...
  ADD KEY `fk_detail_apotek` (`id_apotek`);
...
--
-- Indexes for table `harga_stok_apotek`
--
...
ALTER TABLE `keranjang`
  ...
  ADD KEY `fk_keranjang_apotek` (`id_apotek`);
...
--
ALTER TABLE `booking`
  MODIFY `id_booking` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `notifikasi`
  MODIFY `id_notifikasi` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `apotek`
  ADD CONSTRAINT `fk_apotek_kota` FOREIGN KEY (`id_kota`) REFERENCES `kota` (`id_kota`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `detail_pesanan`
  ADD CONSTRAINT `fk_detail_apotek` FOREIGN KEY (`id_apotek`) REFERENCES `apotek` (`id_apotek`) ON DELETE SET NULL ON UPDATE CASCADE,
...
--
-- Constraints for table `harga_stok_apotek`
--
ALTER TABLE `harga_stok_apotek`
...
--
ALTER TABLE `keranjang`
  ADD CONSTRAINT `fk_keranjang_apotek` FOREIGN KEY (`id_apotek`) REFERENCES `apotek` (`id_apotek`) ON DELETE SET NULL ON UPDATE CASCADE,
